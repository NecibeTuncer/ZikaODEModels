function curve_fitting_ZIKA_Model23SINT
...
%k = [0.000145767388383   0.000005180243571   0.100000000000010     0.0000000001];
k = [0.149459403033   0.5070078725   0.101315421176455   0.000000000097777];
...
dy(3) = Lambda - (beta_v* Iv*S +beta_d * S * I)/(S+I+R)- mu*S + omega*R;
dy(4) = (beta_v*Iv*S + beta_d * S *I)/(S+I+R) - (mu + gamma)*I;
dy(5) = gamma*I - (mu + omega)*R;
dy(6) = (beta_v* Iv*S + beta_d * S *I)/(S+I+R);
end
...
Reproduction_Number = r1/r2 +  k(4)/(mu+k(3))
